...
public class AssessmentResultDefinition {
    ...
    public static final SortOption<GradeBook> 
        ...
        SORT_STUDENT_ID = SortOption.of("Student ID", gradeBook -> gradeBook.enrollment().student().id());
    ...
    public static final FilterOption<GradeBook, ?, ?>
        ...
        FILTER_STUDENT_ID = FilterOption.compare("Academic Leader ID", gradeBook -> gradeBook.enrollment().student().id(), InputStrategy.nonNegativeIntegerField());
