...
public class EnrollmentReportView extends ManagementView<EnrollmentReport> {
    ...
    private Component[] createTableRow(EnrollmentReport report) {
        ...
        return new Component[] {
            ...
            createModuleSection(classGroup.module()),
    ...
    private JPanel createModuleSection(Module module) {
    ...
    private JPanel createLecturerSection(User lecturer) {
        var idLabel = DataList.createText("ID:");
        idLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        return new FlexibleGridBuilder(2)
            ...
            .add(
                ...
                DataList.createText("Name:"),
                DataList.createText(lecturer.name())
            )
            .build();
    }
